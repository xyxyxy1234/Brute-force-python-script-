This is a simple python file which breaks the password of a zip-file using brute-forcing. It utilizes a dictionary file which it then matches with the original password of the file
